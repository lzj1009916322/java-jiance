...
CREATE TABLE `sys_user` (
  ...
  `organization_code` varchar(30) COMMENT '组织编码',
...
CREATE TABLE `sys_organization`  (
  ...
  `super_code` varchar(20) NULL DEFAULT NULL COMMENT '上层组织编码',
  `name` varchar(128) NULL DEFAULT NULL COMMENT '名称',
  `level` tinyint(0) NULL DEFAULT NULL COMMENT '层级',
  `status` varchar(255) NULL DEFAULT NULL COMMENT '状态：0正常，1禁用，9删除',
  PRIMARY KEY (`code`) USING BTREE
) ENGINE=`InnoDB` DEFAULT CHARACTER SET utf8mb4 COMMENT='组织';
...
-- 初始数据 
INSERT INTO `sys_user` (`user_id`, `username`, `password`, `salt`, `email`, `mobile`, `status`, `create_user_id`, `create_time`) VALUES ('1', 'admin', '9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d', 'YzcmCZNvbXocrsz9dm8e', 'admin@wtakeout.com', '13612345678', '1', '1', '2018-11-11 11:11:11');
...
INSERT INTO `sys_menu`(`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES (5, 1, 'SQL监控', 'http://localhost:8080/wtakeout/druid/sql.html', NULL, 1, 'sql', 4);
...
INSERT INTO `schedule_job` (`bean_name`, `params`, `cron_expression`, `status`, `remark`, `create_time`) VALUES ('testTask', 'wtakeout', '0 0/30 * * * ?', '0', '参数测试', now());
